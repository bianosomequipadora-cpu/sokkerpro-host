...
def msg_universal(home, away, minuto, liga, pais, n, mercado, entrada, placar, extra_val=None, cantos_atual=0, stats=None, sh=0, sa=0, fav_final='h', odd_h=None, odd_a=None, odd_b365=None, odd_bano=None, nome=None, tipo=''):
    ...
    if appm_val >= 2.0:
        ...
        alerta = 'Partida Com Pressão ' + quem + '.'
    elif appm_val >= 0.7:
    ...
    keyboard = {'inline_keyboard': [[{'text': '🟣BET365🟣', 'url': 'https://www.bet365.bet.br/#/AX/'}, {'text': '🔵PARIPESA🔵', 'url': 'https://paripesa.com/mobile?bf=667237b941dd4_5426307053'}]]}
    return (msg, keyboard)
