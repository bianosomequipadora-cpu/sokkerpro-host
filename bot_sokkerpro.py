...
def nome_liga_exibicao(liga, pais):
    ...
    PAIS_COMPLETO = {
        ...
        'French Southern Territories': ('tf', 'Territórios Franceses do Sul'),
        ...
        'Belgium': ('be', 'Bélgica'),
        'Benin': ('bj', 'Benin'),
        'Bonaire, Sint Eustatius and Saba': ('bq', 'Países Baixos Caribenhos'),
        ...
        'Saint Barthélemy': ('bl', 'São Bartolomeu'),
        'Belarus': ('by', 'Bielorrússia'),
        'Belize': ('bz', 'Belize'),
        'Bermuda': ('bm', 'Bermudas'),
        'Bolivia, Plurinational State of': ('bo', 'Bolívia'),
        'Brazil': ('br', 'Brasil'),
        'Barbados': ('bb', 'Barbados'),
        'Brunei Darussalam': ('bn', 'Brunei'),
        'Bhutan': ('bt', 'Butão'),
        'Bouvet Island': ('bv', 'Ilha Bouvet'),
        'Botswana': ('bw', 'Botsuana'),
        'Central African Republic': ('cf', 'República Centro-Africana'),
        'Canada': ('ca', 'Canadá'),
        'Cocos (Keeling) Islands': ('cc', 'Ilhas Cocos (Keeling)'),
        'Switzerland': ('ch', 'Suíça'),
        'Chile': ('cl', 'Chile'),
        'China': ('cn', 'China'),
        "Côte d'Ivoire": ('ci', 'Costa do Marfim'),
        'Cameroon': ('cm', 'Camarões'),
        'Congo, The Democratic Republic of the': ('cd', 'Congo - Kinshasa'),
        'Congo': ('cg', 'República do Congo'),
        ...
        'Cuba': ('cu', 'Cuba'),
        'Curaçao': ('cw', 'Curaçao'),
        'Christmas Island': ('cx', 'Ilha Christmas'),
        'Cayman Islands': ('ky', 'Ilhas Cayman'),
        'Cyprus': ('cy', 'Chipre'),
        'Czechia': ('cz', 'Tchéquia'),
        'Germany': ('de', 'Alemanha'),
        'Djibouti': ('dj', 'Djibuti'),
        ...
        'Fiji': ('fj', 'Fiji'),
        'Falkland Islands (Malvinas)': ('fk', 'Ilhas Malvinas'),
        'France': ('fr', 'França'),
        'Faroe Islands': ('fo', 'Ilhas Faroé'),
        'Micronesia, Federated States of': ('fm', 'Micronésia'),
        'Gabon': ('ga', 'Gabão'),
        ...
        'Guam': ('gu', 'Guam'),
        'Guyana': ('gy', 'Guiana'),
        'Hong Kong': ('hk', 'Hong Kong, RAE da China'),
        'Heard Island and McDonald Islands': ('hm', 'Ilhas Heard e McDonald'),
        ...
        'India': ('in', 'Índia'),
        'British Indian Ocean Territory': ('io', 'Território Britânico do Oceano Índico'),
        'Ireland': ('ie', 'Irlanda'),
        'Iran, Islamic Republic of': ('ir', 'Irã'),
        'Iraq': ('iq', 'Iraque'),
        'Iceland': ('is', 'Islândia'),
        'Israel': ('il', 'Israel'),
        'Italy': ('it', 'Itália'),
        ...
        'Latvia': ('lv', 'Letônia'),
        'Macao': ('mo', 'Macau, RAE da China'),
        'Saint Martin (French part)': ('mf', 'São Martinho'),
        'Morocco': ('ma', 'Marrocos'),
        'Monaco': ('mc', 'Mônaco'),
        'Moldova, Republic of': ('md', 'Moldávia'),
        'Madagascar': ('mg', 'Madagascar'),
        'Maldives': ('mv', 'Maldivas'),
        'Mexico': ('mx', 'México'),
        'Marshall Islands': ('mh', 'Ilhas Marshall'),
        'North Macedonia': ('mk', 'Macedônia do Norte'),
        'Mali': ('ml', 'Mali'),
        'Malta': ('mt', 'Malta'),
        'Myanmar': ('mm', 'Mianmar (Birmânia)'),
        'Montenegro': ('me', 'Montenegro'),
        'Mongolia': ('mn', 'Mongólia'),
        'Northern Mariana Islands': ('mp', 'Ilhas Marianas do Norte'),
        ...
        'Niger': ('ne', 'Níger'),
        'Norfolk Island': ('nf', 'Ilha Norfolk'),
        'Nigeria': ('ng', 'Nigéria'),
        ...
        "Korea, Democratic People's Republic of": ('kp', 'Coreia do Norte'),
        'Portugal': ('pt', 'Portugal'),
        'Paraguay': ('py', 'Paraguai'),
        'Palestine, State of': ('ps', 'Territórios palestinos'),
        'French Polynesia': ('pf', 'Polinésia Francesa'),
        'Qatar': ('qa', 'Catar'),
        'Réunion': ('re', 'Reunião'),
        'Romania': ('ro', 'Romênia'),
        'Russian Federation': ('ru', 'Rússia'),
        'Rwanda': ('rw', 'Ruanda'),
        'Saudi Arabia': ('sa', 'Arábia Saudita'),
        'Sudan': ('sd', 'Sudão'),
        'Senegal': ('sn', 'Senegal'),
        'Singapore': ('sg', 'Singapura'),
        'South Georgia and the South Sandwich Islands': ('gs', 'Ilhas Geórgia do Sul e Sandwich do Sul'),
        'Saint Helena, Ascension and Tristan da Cunha': ('sh', 'Santa Helena'),
        'Svalbard and Jan Mayen': ('sj', 'Svalbard e Jan Mayen'),
        'Solomon Islands': ('sb', 'Ilhas Salomão'),
        'Sierra Leone': ('sl', 'Serra Leoa'),
        'El Salvador': ('sv', 'El Salvador'),
        'San Marino': ('sm', 'San Marino'),
        'Somalia': ('so', 'Somália'),
        'Saint Pierre and Miquelon': ('pm', 'São Pedro e Miquelão'),
        'Serbia': ('rs', 'Sérvia'),
        ...
        'Sweden': ('se', 'Suécia'),
        'Eswatini': ('sz', 'Essuatíni'),
        'Sint Maarten (Dutch part)': ('sx', 'Sint Maarten'),
        'Seychelles': ('sc', 'Seicheles'),
        'Syrian Arab Republic': ('sy', 'Síria'),
        'Turks and Caicos Islands': ('tc', 'Ilhas Turcas e Caicos'),
        'Chad': ('td', 'Chade'),
        'Togo': ('tg', 'Togo'),
        'Thailand': ('th', 'Tailândia'),
        'Tajikistan': ('tj', 'Tadjiquistão'),
        'Tokelau': ('tk', 'Tokelau'),
        ...
        'Tanzania, United Republic of': ('tz', 'Tanzânia'),
        'Uganda': ('ug', 'Uganda'),
        'Ukraine': ('ua', 'Ucrânia'),
        'United States Minor Outlying Islands': ('um', 'Ilhas Menores Distantes dos EUA'),
        'Uruguay': ('uy', 'Uruguai'),
        'United States': ('us', 'Estados Unidos'),
        'Uzbekistan': ('uz', 'Uzbequistão'),
        'Holy See (Vatican City State)': ('va', 'Cidade do Vaticano'),
        'Saint Vincent and the Grenadines': ('vc', 'São Vicente e Granadinas'),
        'Venezuela, Bolivarian Republic of': ('ve', 'Venezuela'),
        'Virgin Islands, British': ('vg', 'Ilhas Virgens Britânicas'),
        'Virgin Islands, U.S.': ('vi', 'Ilhas Virgens Americanas'),
        'Viet Nam': ('vn', 'Vietnã'),
        'Vanuatu': ('vu', 'Vanuatu'),
    ...
    mapa = {
        ...
        ('First Liga', 'Montenegro'): '🇲🇪 Montenegro. Primeira Liga',
        ('Inkasso-Deildin', 'Iceland'): '🇮🇸 Islândia. Inkasso-Deildin',
    ...
    paises = {
        ...
        'Tunisia': ('🇹🇳', 'Tunísia'), 'Nigeria': ('🇳🇬', 'Nigéria'), 'Ghana': ('🇬🇭', 'Gana'), 'Azerbaijan': ('🇦🇿', 'Azerbaijão'), 'Lithuania': ('🇱🇹', 'Lituânia'), 'Bulgaria': ('🇧🇬', 'Bulgária'), 'Estonia': ('🇪🇪', 'Estônia')
    }
    paises.update(PAIS_COMPLETO)
    ...
    traducoes = {
        ...
        'First Liga': 'Primeira Liga', 'Second Division': 'Segunda Divisão',
    ...
    if pais.startswith('__ISO__:'):
        codigo = pais.split(':', 1)[1].lower()
        pais_pt = ISO_PAIS_PT.get(codigo, '')
        if pais_pt:
            nome_liga = liga
            for origem, destino in traducoes.items():
                nome_liga = nome_liga.replace(origem, destino)
            flag = ''.join(chr(127397 + ord(c)) for c in codigo.upper())
            return nome_liga + ' (' + flag + ' ' + pais_pt + ')'
...
def msg_universal(home, away, minuto, liga, pais, n, mercado, entrada, placar, extra_val=None, cantos_atual=0, stats=None, sh=0, sa=0, fav_final='h', odd_h=None, odd_a=None, odd_b365=None, odd_bano=None, nome=None, tipo='', probabilidade=None):
    ...
    sep = '━' * 22
    liga=nome_liga_exibicao(liga, pais)
    ...
    keyboard = {'inline_keyboard': [[{'text': '🟢BET365🟢', 'url': 'https://www.bet365.bet.br/#/AZ/'}, {'text': '🔴SUPERBET🔴', 'url': 'https://superbet.bet.br/apostas/ao-vivo'}], [{'text': '🟠BETANO🟠', 'url': 'https://www.betano.bet.br/live/'}, {'text': '🔵PARIPESA🔵', 'url': 'https://paripesa.com/en/live/football'}]]}
    return (msg, keyboard)
